...
#SERVICE-WISE DAILY FORECAST (Next 365 Days, clipped ≥ 0)
#============================
...
output_folder = r"C:\AI Project\cost\azure_daily_forecast_output"
...
forecast_service_daily.to_csv(
   fr"{output_folder}\azure_forecast_service_wise_daily.csv",    
    index=False
 )
